                      ...
                      <div className="flex-1 overflow-y-auto p-6 md:p-10 space-y-6">
                        {chatMessages.length === 0 ? (
                          <div className="flex flex-col items-center justify-center h-full text-center space-y-6 max-w-2xl mx-auto">
                            <div className="w-20 h-20 bg-indigo-50 rounded-3xl flex items-center justify-center rotate-3 shadow-inner">
                              ...
                              {['Is there parking?', "What's nearby?", 'Pet policy?', 'Furnishing details?'].map(q => (
                                <button
                                  ...
                                  onClick={() => {
                                    setChatInput(q);
                                    setTimeout(() => {
                                      const btn = document.getElementById('send-btn-max');
                                      if (btn) btn.click();
                                    }, 100);
                                  }}
                        ...
                        <form onSubmit={async (e) => {
                          ...
                          <div className="relative flex items-center gap-4 bg-gray-50 p-2 rounded-2xl border border-gray-100 focus-within:border-indigo-300 focus-within:ring-4 focus-within:ring-indigo-500/5 transition-all">
                            ...
                            <button
                              ...
                              className="bg-indigo-600 text-white p-4 rounded-xl hover:bg-indigo-700 disabled:opacity-50 transition-all shadow-lg hover:scale-105 active:scale-95"
                            >
